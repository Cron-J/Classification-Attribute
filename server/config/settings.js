...
module.exports = {
    server: {
        ...
        listenPort: 3001,                                   // The port on which the server is to listen (means that the app is at http://localhost:8081 for instance)
    ...
    client: {
        listenHost: 'localhost',
        listenPort: 3036,                                   // The port on which the server is to listen (means that the app is at http://localhost:8000 for instance)
    },
    DB: {
        dialect: "mongodb",
        host: '127.0.0.1',
